...
//    public void updateThread(Bundle bundle,String phoneNumber) {
//        thread = null;
//
//        if (bundle == null) {
...
//        final MediaPlayer mediaPlayer = MediaPlayer.create(ReceiverActivity.this,R.raw.mario);
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    if (StreamStatus.PUBLISHING.equals(streamStatus)) {
                                        ...
                                        mMuteVideo.setEnabled(false);
                                        mMuteVideo.setChecked(false);
                                        ReceiverActivity.this.stream = null;
                                    }
